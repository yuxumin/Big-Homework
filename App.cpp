			...
			else 
				{
					...
					if(FindIt == 0)
					{
						...
						while(Success)
						{
							...
							cout<<"再次输入密码（小于20个字符）"<<endl;
							cin.getline(TempPass2,19);
							int Diff = strcmp(TempPass,TempPass2);
							if(Diff)
							{
									  system("cls");
										cout<<endl;
